...
mod test {
    ...
    fn german_content_simple() -> HashMap<String, String> {
        ...
        map.insert(
            ...
            "Die Bedrohungsakteursgruppe 'Böse Org'".to_string(),
        );
        map
    }
    ...
    fn french_content_list() -> HashMap<String, Vec<String>> {
        ...
        map.insert(
            "goals".to_string(),
            vec!["Voler de l'argent en banque".to_string(), "".to_string()],
        );
        map
    }
    ...
    fn german_content_object() -> HashMap<String, HashMap<String, Value>> {
        ...
        inner.insert(
            "description".to_string(),
            json!("Leitet die operativen Aktivitäten"),
        );
    ...
    #[test]
    fn serialize_language_content_invalid_subkey() {
        let mut content = StixDictionary::new();
        let _ = content.insert("a", ContentType::String("boo".to_string()));
        let language_content =
            LanguageContentBuilder::new("identity--2d1c6ab3-5e4e-48ac-a32b-f0c01c2836a8")
                .unwrap()
                .insert_content("es", content)
                .unwrap()
                .build();
