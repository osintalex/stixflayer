...
mod test {
    ...
    fn serialize_malware() {
        let malware = DomainObjectBuilder::new("malware")
            ...
            .unwrap()
            .malware_types(vec!["adware".to_string(), "exploit-kit".to_string()])
            .unwrap()
            .set_family(true)
            .unwrap()
            ...
            .operating_system_refs(vec![Identifier::from_str(
                "software--8e2e2d2b-17d4-5cbf-938f-98ee46b3cd3f",
            )
            .unwrap()])
            .unwrap()
        ...
        let json = r#"{
            ...
            "malware_types": ["adware","exploit-kit"],
            "is_family": true,
            "aliases": ["CryptoDefense", "WannaCry"],
            "first_seen": "2023-10-01T00:00:00Z",
            "last_seen": "2023-10-01T00:00:00Z",
            "operating_system_refs":["software--8e2e2d2b-17d4-5cbf-938f-98ee46b3cd3f"],
            "architecture_execution_envs" : ["arm", "powerpc"],
            "implementation_languages": ["applescript","bash"],
            "capabilities" : ["anti-debugging","anti-sandbox"],
            "spec_version": "2.1",
    ...
    fn serialize_malware_analysis() {
        let malware_analysis = DomainObjectBuilder::new("malware-analysis")
            ...
            .unwrap()
            .host_vm_ref(
                Identifier::from_str("software--5b7f978f-7299-57f5-b5ff-f043f6b3cf8d").unwrap(),
            )
            .unwrap()
            .operating_system_ref(
                Identifier::from_str("software--2a40a042-e9d3-529d-b029-7a9a3c4e7b79").unwrap(),
            )
            .unwrap()
        ...
        let json = r#"{
                ...
                "host_vm_ref": "software--5b7f978f-7299-57f5-b5ff-f043f6b3cf8d",
                "operating_system_ref":"software--2a40a042-e9d3-529d-b029-7a9a3c4e7b79",
                "installed_software_refs":["software--8e2e2d2b-17d4-5cbf-938f-98ee46b3cd3f"],
